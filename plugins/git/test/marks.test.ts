...
describe('текст из коммита принадлежит файлу', () => {
  ...
  it('файла не было в истории — это тоже ответ, и он пустой', async () => {
    const marks = new GitMarks(remoteAnswering({ 'new.ts': null }));
