...
describe('строка для оболочки', () => {
  it('простые слова не трогает, остальные берёт в одинарные кавычки', () => {
  ...
  it('переменные окружения едут перед командой через env, null пропускается', () => {
  ...
  it.skipIf(process.platform === 'win32')('настоящий sh получает те же слова и то же окружение', () => {
